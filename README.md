...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=32&pause=1000&color=00BFFF&center=true&vCenter=true&random=false&width=600&lines=Hey+%F0%9F%91%8B+I'm+Adrian;Backend+Developer+in+training;AI-Augmented+Development;8+months+of+intensive+learning" alt="Typing SVG" />

<br/>

<!-- Badges de estado -->
[![Estudiante](https://img.shields.io/badge/🎓-Estudiante%20de%20Software-00BFFF?style=flat-square)]()
[![8 meses](https://img.shields.io/badge/⏱️-8%20meses%20aprendiendo-FF6B6B?style=flat-square)]()
[![Medellín](https://img.shields.io/badge/📍-Medellín,%20Colombia-47A248?style=flat-square)]()
...
<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- SECCIÓN: SOBRE MÍ — Storytelling, no lista genérica              -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
...
- 📚 Completé **21+ certificaciones** en Platzi, Big School, FreeCodeCamp, Anthropic y más
- 🏗️ Construí un **backend REST completo** (Node.js + Express + MySQL)
- 🤖 Me especialicé en **integrar IA al flujo de desarrollo** — como herramienta real
- 🧠 Aprendí a usar **Claude Code, Gemini CLI, OpenCode, ChatGPT** como extensiones de mi cerebro de dev
...
<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- SECCIÓN: STACK — Organizado por función, no por categoría        -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- SECCIÓN: AI — El diferenciador REAL                              -->
<!-- ═══════════════════════════════════════════════════════════════════ -->

## 🤖 AI-Augmented Development — Mi diferenciador

> No solo uso IA como herramienta — **la integro en mi flujo de desarrollo**.
...
| Cert | Plataforma | Año |
|------|-----------|-----|
| JavaScript | FreeCodeCamp | 2026 |
| Claude Code in Action | Anthropic | 2025 |
| Prompt Engineering | Platzi | 2025 |
| Herramientas IA para Devs | Platzi | 2025 |
| Gemini AI | Santander | 2025 |
...
[![Repo](https://img.shields.io/badge/📦-Ver%20Repositorio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/4DR14N-DEV/backend-parking-project)
...
<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- SECCIÓN: ACTUALMENTE & PRÓXIMOS — Roadmap visible               -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════ -->
<!-- SECCIÓN: CONTACTO — Claro y directo                              -->
<!-- ═══════════════════════════════════════════════════════════════════ -->
...
<!-- Contador de visitas -->
<img src="https://komarev.com/ghpvc/?username=4DR14N-DEV&color=00BFFF&style=flat-square&label=Profile+Views" alt="profile views" />
